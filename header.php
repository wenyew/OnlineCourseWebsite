...
<div class="page-container">
    <div class="top_header">
        <a style="text-decoration: none;" class="brand-container" href="stu-home.php">
            <div class="logo">
        ...
        <div class="homepage_tab">
            <button onclick="window.location.href = 'stu-home.php'">My Learning</button>
            <button onclick="window.location.href = 'stu-performance-report.php'">My Summary</button>
