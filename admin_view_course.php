...
$fromAdmin = false;
if (isset($_GET['course_id']) && !isset($_GET['originType']))  {
    $courseId = $_GET['course_id'];
    $fromAdmin = false;
} else if (isset($_GET['course_id']) && isset($_GET['originType']) && $_GET['originType'] == "admin") {
    $courseId = $_GET['course_id'];
    $fromAdmin = true;
}
    ...
    <div class="main-content">
        <div class="whiteSectionBg">
            <div class="contentSection">
                <button class="purpleBtn" id="backButton" onclick="window.history.back();">
                Back</button>
                                    ...
                                    while ($row = mysqli_fetch_assoc($reviewExe)) {
                                        if ($row["rating"] !== null) {
                                            ...
                                            '<div class="reviewCard">
                                                <a class="studentLink" href="admin-view-stu-profile.php?user_email='.$row["user_email"].'">
